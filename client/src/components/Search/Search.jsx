...
const Search = () => {
  return (
    <article className="w-1/3 h-9 flex items-center justify-center ">
      <form action="" method="get" className="w-full saturate-[100%] flex items-center bg-gray rounded-3xl backdrop-blur-sm ">
        ...
        <Button bg={'bg-transparent'} px="px-3" textColor="text-black" className="absolute right-4" value={<IoSearchOutline />} />
      </form>
    </article>
  )
}
